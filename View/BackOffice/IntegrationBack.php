      ...
      <div class="seq-preloader">
        ...
        <nav>
          ...
          <ul>
            ...
            <li><a href="#3"><i class="fa fa-pencil"></i> <em>Evaluations</em></a></li> 
...
<div class="slide" id="3">
  <div class="content second-content">
    <div class="container-fluid custom-container">
      ...
      <div class="column">
        <a href="AddEvaluation.php" id="btn1" class="btn custom-btn">Add Evaluation</a>
        <a href="AddQuestion.php" id="btn3" class="btn custom-btn">Add Question </a>
      </div>

      <!-- Deuxième colonne de boutons -->
      <div class="column">
        <a href="listEvaluation.php" id="btn2" class="btn custom-btn">List of Evaluations</a>
        <a href="ListQuestion.php" id="btn4" class="btn custom-btn">List of Questions </a>
      </div>
    </div>
  </div>
</div>
...
<style>
  .custom-container {
    ...
    min-height: 300px;          /* Assure une hauteur minimale du conteneur */
  }

  .column {
    display: flex;              /* Utilise Flexbox dans chaque colonne */
    flex-direction: column;     /* Aligne les boutons en colonne */
    margin: 10px;               /* Marge entre les colonnes */
  }

  .custom-container a {
    margin: 10px 0;             /* Espace vertical entre les boutons */
    padding: 10px 20px;         /* Respecte leur apparence */
    border-radius: 0px;         /* Coins non arrondis */
    text-align: center;
    text-decoration: none;      /* Supprime le soulignement des liens */
    width: 200px;               /* Fixe une largeur uniforme pour tous les boutons */
  }
