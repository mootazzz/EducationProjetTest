...
?>
        ...
        <div class="masonry">
            <div class="row">
                ...
                <a href="ListEvaluationFront.php" id="btn1" class="btn custom-btn">View Evaluations</a>
                </div>
            </div>
        </div>            
    </div>
    <div class="row">
        ...
        <!--   UNE PLACE POUR INTEGRER UN AUTRE MODULE  -->
           <!DOCTYPE html>
           <html lang="en">
           <head>
            <meta charset="UTF-8">
    ...
    .btn-info {
        background-color: rgb(36, 36, 36) !important;
        color: white !important;
        border: 2px solid rgb(69, 72, 154) !important;
    }
